...
public class Cube : MonoBehaviour {
    ...
    {
        int quads = (xSize * ySize + xSize * zSize + zSize * ySize) * 2;
    ...
    private void Setting()
    {
        ...
        collider.center = new Vector3((float)xSize / 2.0f, (float)ySize / 2, (float)zSize / 2);
        collider.size = new Vector3(xSize, ySize, zSize);

        transform.localScale = new Vector3((float)1.0f / xSize, (float)1.0f / ySize, (float)1.0f / zSize);
    }
}
